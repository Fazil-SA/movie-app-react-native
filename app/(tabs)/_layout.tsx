...
const TabIcon = ({ focused, title, icon }: any) => {
  if (focused) {
    return (
      <ImageBackground source={images.highlight} className="flex flex-row w-full flex-1 min-w-[125px] min-h-20 mt-4 justify-center items-center rounded-full overflow-hidden border-none">
